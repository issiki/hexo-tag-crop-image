...
describe(config01, () => {
    ...
    const expected = `<span style="width:1111px;height:2222px;background:url(${image_url}) no-repeat scroll 3333px 4444px transparent;"><span style="width:100%;height:100%;"></span></span>`
...
describe(config02, () => {
    ...
    const expected = `<span style="width:0;height:0;background:url(${image_url}) no-repeat scroll 0 0 transparent;"><span style="width:100%;height:100%;"></span></span>`
    it(`should return ${expected}`, () => {
        assert.equal(crop(config), expected);
    });
});
